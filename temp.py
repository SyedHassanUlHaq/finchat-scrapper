...
async def scrape_event_names():
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.locator('(//div[@class="m_89d33d6d mantine-Tabs-list"])[last()]//button[2]').click()
            # await page.click('#mantine-5hg9hhom9-tab-Report')
            await asyncio.sleep(5)  # Wait for the page to load
            await page.locator('button[data-testid="get-file__download-button"]').click()
